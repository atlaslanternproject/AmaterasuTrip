...
class AuthController {
  ...
  Future<void> changeEmail({
    ...
    await _repository.reauthenticateWithPassword(password: currentPassword);

    await _repository.changeEmail(newEmail: newEmail);
  }

  Future<void> updateFirestoreEmail({required String email}) async {
    await _userRepository.updateEmail(email: email.trim().toLowerCase());
  }
