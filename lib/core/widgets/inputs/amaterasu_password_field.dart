...
class AmaterasuPasswordField extends StatefulWidget {
  ...
  @override
  State<AmaterasuPasswordField> createState() => _AmaterasuPasswordFieldState();
}

class _AmaterasuPasswordFieldState extends State<AmaterasuPasswordField> {
  bool _obscure = true;
  @override
  Widget build(BuildContext context) {
    return TextField(
      ...
      style: const TextStyle(color: AmaterasuColors.white),
      decoration: InputDecoration(
        hintText: widget.hintText,
        hintStyle: const TextStyle(color: AmaterasuColors.white54),
